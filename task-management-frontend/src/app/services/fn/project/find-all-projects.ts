...
export function findAllProjects(http: HttpClient, rootUrl: string, params?: FindAllProjects$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseProjectResponse>> {
